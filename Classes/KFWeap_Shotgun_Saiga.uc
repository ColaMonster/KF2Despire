...
class KFWeap_Shotgun_Saiga extends KFWeap_ShotgunBase;
...
defaultproperties
{
    ...
    InventorySize=10
    GroupPriority=100
    WeaponSelectTexture=Texture2D'ui_weaponselect_tex.UI_WeaponSelect_AA12'   //create new icon?
    ...
    // Content
    PackageKey="Saiga"
    FirstPersonMeshName="Wep_1P_AA12_MESH.Wep_1stP_AA12_Rig"                //new model goes here
    FirstPersonAnimSetNames(0)="Wep_1P_AA12_ANIM.Wep_1stP_AA12_Anim"
    PickupMeshName="WEP_3P_AA12_MESH.Wep_AA12_Pickup"                       //new ground model
    ...
    FireInterval(DEFAULT_FIREMODE)=0.1 // 150 RPM  //Default 0.2 for 300 RPM -  Trying 0.1 for 150 RPM
    ...
    InstantHitDamageTypes(ALTFIRE_FIREMODE)=class'KFDT_Ballistic_Saiga'
    ...
    // BASH_FIREMODE
    InstantHitDamageTypes(BASH_FIREMODE)=class'KFDT_Bludgeon_Saiga'
